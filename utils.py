...
def segment_lung(img):
    ...
    # Cutting non-ROI Regions. The cuts applied to each region
    # bounding box were determined empirically and seem to work
    # well for the LUNA data, but may not be generally applicable ### MEJORAR
    ...
    for prop in regions:
        B = prop.bbox
        # y esto por que? es como si no tuviese en cuenta los bordes o la regio exterior al pulmon
