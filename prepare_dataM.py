...
class MakeDataSet:
    def __init__(self, LIDC_Patients_list, IMAGE_DIR, MASK_DIR,CLEAN_DIR_IMAGE,CLEAN_DIR_MASK,META_DIR, padding, confidence_level=0.5):
    ...
    def prepare_dataset(self):
        ...
        for patient in tqdm(self.IDRI_list):
            ...
            scan = pl.query(pl.Scan).filter(pl.Scan.patient_id == pid, pl.Scan.slice_thickness <= 2).first()
            ...
            vol = scan.to_volume() # dicom volume, the scan can be converted to a NumPy array for image-processing
            ...
            if len(nodules_annotation) > 0:
                ...
                # This current for loop iterates over total number of nodules in a single patient
                    ...
                    # cbbox method returns a tuple of slices corresponding to the nodule bounding box indices. 
                    ...
                    for nodule_slice in range(mask.shape[2]):
                        ...
                        # I am not sure why but some values are stored as -0. <- this may result in datatype error in pytorch training
...
if __name__ == '__main__':
    ...
    test= MakeDataSet(LIDC_IDRI_list,IMAGE_DIR,MASK_DIR,CLEAN_DIR_IMAGE,CLEAN_DIR_MASK,META_DIR,padding,confidence_level)
